...
3. Im Kontextmenü (rechte Maustaste) kann eine neue Datenbankverbindung zur Server Datenbank hergestellt werden (siehe @fig-connect2).
...
![Catalog Fenster in ArcGIS Pro](figures/screenshot_connect1.jpg){#fig-connect1}

![Neue Datenbankverbindung herstellen](figures/screenshot_connect2.jpg){#fig-connect2}
...
?- Taste) gesetzt werden muss. Bei Copy & Paste aus pdf-Dateien wird oft das Anführungszeichen 
...
8. Navigieren Sie im Browser von pgAdmin zur Tabelle "tierarten".
...
3. Laden Sie die Datei "tierarten.sql" [aus dem Moodle](https://moodle.zhaw.ch/mod/resource/view.php?id=159550) und speichern Sie in Ihrem Ordner.
...
1. Laden Sie die Datei "waelder.zip" [aus dem Moodle](https://moodle.zhaw.ch/mod/resource/view.php?id=159552) und entpacken Sie die Dateien. Es handelt sich um ein Shapefile mit einigen Wäldern.
...
7. Kontextmenü der Feature Class "waelder"→Load Data (siehe @fig-db2-uebung8-1)
...
1. Laden Sie die Datei "sichtungsmeldungen.sql" [aus dem Moodle](https://moodle.zhaw.ch/mod/resource/view.php?id=159551). Es handelt sich um eine SQL-Datei mit Sichtungsmeldungen von Tieren.
