...
6. Selektieren Sie die Verbindung und achten auf die Registerkarten im ArcGIS Pro Hauptmenü (ganz oben). Es wird ein neues Register "Data Source" / "Versioning" angezeigt.
...
12. Wechseln Sie jetzt zurück auf die DEFAULT Version. Dies können Sie über das Kontextmenü des Eintrags im Contents-Fenster→Change Version. Alternativ kann die Version auch in der Registerkarte "Data Source"→Versioning gewechselt werden.
...
13. Zeigen Sie die Registerkarte "Data Source – Versioning" an.
...
## (Optional) Übung 12: Abfragen in pgAdmin und ArcGIS Pro überprüfen
