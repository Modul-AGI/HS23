...
Um ein neues Environment mit dem Namen `geopython` zu erstellen und aktivieren geht man wie folgt vor:

```bash
conda create --name geopython           # erstellt das Environment
activate geopython                      # aktiviert das Environment
```
