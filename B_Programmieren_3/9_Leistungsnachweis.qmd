...
4. Schritt: Spatial Join mit wald.gpkg
5. Schritt: Der Anteil der Zeckenstiche im Wald Berechnen (siehe @sec-spatialjoin)
...
9. Schritt: Eine Karte mit den simulierten Zeckenstichen erstellen (siehe @sec-geoviz)


![](figures/mermaid-diagram-2022-10-13-112927.svg)
...
Sorge dafür, dass der Bericht sauber und ordentlich daher kommt (vermeide zum Beispiel lange Python Messages im Bericht, entferne unnötigen Code). ührt die Datenanalyse durch, indem ihr den Python Code **mit Markdown Text** unterstützt. Beschreibt und begründet eure Analyseschritte und wie die Resultate zu interpretieren sind.. Beschreibt und begründet eure Analyseschritte und wie die Resultate zu interpetieren sind. Der Fokus soll auf der technischen Umsetzung liegen, nicht auf der Interpretation der Resultate.
