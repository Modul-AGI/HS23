...
2. Um technische Probleme zu vermeinden, haben wir heute eine ZHAW-eigene Cloud Lösung vorbereitet. Es handelt sich dabei um eine *gehostete* Version von Jupyter Lab, auf welche ihr auf folgender Webseite mit eurem ZHAW Benutzername und passwort einloggen könnt: [statistik-ide.zhaw.ch](https://statistik-ide.zhaw.ch). **Wer allerdings lieber lokal arbeiten möchte kann dies gerne tun, mit den Kentnissen aus Programmieren I - III sollte das gut möglich sein**.

![](figures/jupyter_notebook_1.PNG)

3. Wenn die Session geladen ist, könnt ihr eure Übung files über dem `Upload` Button hochladen. Öffnet anschliessend das Jupyter Notebook `Musterloesung.ipynb`.
