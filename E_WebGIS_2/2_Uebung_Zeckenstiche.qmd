...
- `embed-resources: true`:  Generiert ein einzige html File.
- `code-fold: true`: Alle Code Cells werden eingekappt.
...
Benutze zudem die Cell Options um euren Code sauber darzustellen. Nutzt dazu `echo` und `output` um unnötige Cell Codes und Outputs nicht auszugeben. Benenne zudem alle eingeklappten Code Cells mittels `code-summary` sinnvoll. 
